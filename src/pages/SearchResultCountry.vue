<template>
  <div class="container">
    <div class="header">
      <input class="search-area" type="text" placeholder="Search Location">
      <i class="fa-solid fa-magnifying-glass"></i>
    </div>
   <div>
     <svg aria-label="Instagram" class="_ab6-"
          color="rgb(0, 0, 0)"
          fill="rgb(0, 0, 0)"
          height="29" role="img"
          viewBox="32 4 113 32"
     ...
     <div class="searched">
       <div class="country">Mumbai</div>
       <div class="country">Pune</div>
     </div>
     <div class="update-temperature">
       <div class="nhiet-do">
         <div class="country-search">Mumbai</div>
         <div class="o-c">
