<template>
  <div class="menu">
    <div>
      <router-link to="/InstagramPage">
        <div class="icon icon-mt">
          <svg aria-label="Instagram" class="icon-mt"
               color="rgb(0, 0, 0)"
               fill="rgb(0, 0, 0)"
               height="29" role="img"
               viewBox="32 4 113 32"
      ...
      <router-link to="/" class="icon icon-dt">
        <svg aria-label="Instagram" class="" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24" role="img"
      ...
      <div class="link">
        <router-link to="/" class="item-menu">
          <svg aria-label="Home" class="_ab6- icon-no-active" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24"
               role="img"
          ...
          <svg aria-label="Home" class="_ab6- icon-active" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24"
               role="img"
               viewBox="0 0 24 24" width="24">
            <path
          ...
          <div class="name-menu active">Home</div>
        </router-link>
        <a class="item-menu">
          <svg aria-label="Search" class="_ab6- icon-menu"
               color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)"
               height="24" role="img" viewBox="0 0 24 24" width="24">
            <path
                d="M19 10.5A8.5 8.5 0 1 1 10.5 2a8.5 8.5 0 0 1 8.5 8.5Z" fill="none" stroke="currentColor"
          ...
          <div class="name-menu">Search</div>
        </a>
        <router-link to="/explore" class="item-menu">
          <svg aria-label="Explore" class="_ab6- icon-no-active" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24"
               role="img"
               viewBox="0 0 24 24" width="24">
          ...
          <svg aria-label="Explore " class="_ab6- icon-active" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24"
               role="img"
               viewBox="0 0 24 24" width="24">
            <path
          ...
          <div class="name-menu">Explore</div>
        </router-link>
        <router-link to="/reels" class="item-menu">
          <svg aria-label="Reels" class="_ab6- icon-no-active" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24"
               role="img"
               viewBox="0 0 24 24" width="24">
          ...
          <svg aria-label="Reels" class="_ab6- icon-active" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24"
               role="img"
               viewBox="0 0 24 24" width="24">
            <path
          ...
          <div class="name-menu">Reels</div>
        </router-link>
        <router-link to="/messengerinstagram" class="item-menu">
          <svg aria-label="Messenger" class="x1lliihq x1n2onr6 icon-menu icon-no-active" color="rgb(0, 0, 0)"
               fill="rgb(0, 0, 0)"
               height="24" role="img"
          ...
          <svg aria-label="Messenger" class="_ab6- icon-active" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24"
          ...
          <div class="name-menu">Messages</div>
        </router-link>
        <a class="item-menu">
          <svg aria-label="Notifications" class="_ab6- icon-menu" color="rgb(0, 0, 0)"
               fill="rgb(0, 0, 0)" height="24" role="img"
               viewBox="0 0 24 24" width="24">
            <path
          ...
          <div class="name-menu">Notifications</div>
        </a>
        <MoreMenu/>
        <router-link to="/personal" class="item-menu">
          <img class="avt" src="@/assets/avt.png"/>
          <div class="name-menu">Profile</div>
        </router-link>
      </div>
      <!--      <MenuInstagramDt/>-->
    </div>
    <div class="item-menu">
      <svg aria-label="Settings" class="icon-menu icon-no-active"
        ...
        <line fill="none"
              stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" x1="3" x2="21"
              y1="12" y2="12"></line>
        <line fill="none" stroke="currentColor" stroke-linecap="round"
              stroke-linejoin="round" stroke-width="2" x1="3" x2="21" y1="20" y2="20"></line>
      </svg>
      <div class="name-menu">More</div>
      <div>
        <div></div>
      </div>
    </div>
...
<script>
import MoreMenu from "@/pages/instagram/MoreMenu.vue";
...
.menu {
  ...
  border-right: 1px solid rgba(228, 228, 228, 0.83);
  display: flex;
...
.router-link-exact-active .name-menu {
  font-size: 16px;
  font-weight: 700;
  line-height: 24px;
}

.router-link-exact-active ._ab6- {
  color: black;
}
