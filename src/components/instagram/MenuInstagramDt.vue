<template>
  <div class="menu">
    <router-link to="/">
      ...
      <svg aria-label="Home" class="_ab6- icon-active" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24" role="img"
           viewBox="0 0 24 24" width="24">
        <path
    ...
    <router-link to="/reels">
      <svg aria-label="Reels" class="_ab6- icon-no-active" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24" role="img"
           viewBox="0 0 24 24" width="24">
      ...
      <svg aria-label="Reels" class="_ab6- icon-active" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24" role="img"
           viewBox="0 0 24 24" width="24">
        <path
    ...
    <router-link to="/messengerinstagram">
      <svg aria-label="Messenger" class="_ab6-" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24" role="img"
           viewBox="0 0 24 24" width="24">
        <path
